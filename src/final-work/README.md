...
```
cd existing_repo
git remote add origin https://gitlab.com/esaii/software_tools/2025/team16/final-work.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/esaii/software_tools/2025/team16/final-work/-/settings/integrations)
